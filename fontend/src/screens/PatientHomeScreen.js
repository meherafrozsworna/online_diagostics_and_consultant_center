                        ...
                        <ul id="nav">
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <h3>
                                                    ...
                                                    26/06/21: A Sample collector
                                                    will visit you within 2
                                                    days.
                                                </h3>{' '}
                                            </li>
                                        </ul>
                            ...
                            <li id="notification_li">
                                ...
                                <span
                                    id="notification_count"
                                    className={
                                        this.state.isToggle3On ||
                                        this.state.report_notif == 0
                                            ? 'hidden'
                                            : ''
                                    }
                                >
                                    {this.state.report_notif}
                                </span>
                                <div
                                    id="notificationContainer"
                                    className={
                                        this.state.isToggle3On ? '' : 'hidden'
                                    }
                                >
                                    <div id="notificationTitle">
                                        New Reports
